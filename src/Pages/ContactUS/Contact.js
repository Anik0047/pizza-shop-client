    ...
    return (
        <div>
            ...
            <div className='pizzaBackground py-20'>
                <div className='container mx-auto'>
                    <div className='grid justify-items-start md:grid-cols-2'>
                        <div className='text-left text-white ps-20'>
                        ...
                        <div className='text-white mt-20 md:mt-0 mx-auto md:mx-0 md:ms-14'>            
                            <form onSubmit={handleSubmit(contactinfo)}>
                                <div>
                                    <input {...register("firstName")} type="text" placeholder="First Name" className="input w-46 md:w-96 bg-inherit border-0  border-b-4 border-slate-600" />
                                </div>
                                <div>
                                    <input {...register("lastName")} type="text" placeholder="Last Name" className="input w-46 md:w-96 bg-inherit border-0  border-b-4 border-slate-600 my-6" />
                                </div>
                                <div>
